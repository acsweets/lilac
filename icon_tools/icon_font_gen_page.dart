...
class IconFontGenPage extends StatefulWidget {
  const IconFontGenPage({super.key});

  @override
  State<IconFontGenPage> createState() => _IconFontGenPageState();
}

class _IconFontGenPageState extends State<IconFontGenPage> with AutomaticKeepAliveClientMixin {
...
//
  ...
  void _initData() async {
    ...
    String? configStr = sp.getString(Keys.iconFontGenConfig);
    if (configStr != null) {
  ...
  void doGen() {
    ...
    sp.setString(Keys.iconFontGenConfig, json.encode(config));
  }
...
class FileSelectorInput extends StatelessWidget {
  ...
  const FileSelectorInput(
      {super.key, required this.hintText, this.controller, required this.label, this.pickerDir = false});
